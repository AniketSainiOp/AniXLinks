...
This project is provided free of charge under the **MIT License**. You are permitted to:

- **Use**: Freely download and use the playlists for personal viewing.
- **Modify**: Fork the repository and adapt the code to your needs.
- **Share**: Distribute your modified versions.

However, you must include the original copyright and license notice in any copy or substantial portion of the software.
...
- The author **does not host, create, or distribute any of the media content** linked in the playlists. The script simply acts as an aggregator.
